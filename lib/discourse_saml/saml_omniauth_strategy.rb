...
class ::DiscourseSaml::SamlOmniauthStrategy < OmniAuth::Strategies::SAML
  ...
  def request_phase
    with_settings do |settings|
      ...
      puts "AMA: create_xml_document owner: #{OneLogin::RubySaml::Authrequest.instance_method(:create_xml_document).owner rescue 'NOT FOUND (Public)'}"
      puts "AMA: create_xml_document private owner: #{OneLogin::RubySaml::Authrequest.private_instance_method(:create_xml_document).owner rescue 'NOT FOUND (Private)'}"
